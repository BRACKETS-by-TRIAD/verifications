...
class ExampleController
{
    public function indexInvoices()
    {
        ...
        return View::make('invoices.indexInvoices')->withInvoices($invoices);
    }
    ...
    {
        return Verification::verify('download-invoice', '/invoices', function () use ($invoice) {
    ...
    {
        return Verification::verify('download-invoice', '/invoices/autoDownloadInvoice/'.$invoice->id, function () use ($invoice) {
    ...
    {
        return Verification::verify('download-invoice', '/invoices/showDownloadInvoice/'.$invoice->id, function () use ($invoice) {
    ...
    // **************** 4.
    // POST with middleware "verifications.verify:download-invoice"
